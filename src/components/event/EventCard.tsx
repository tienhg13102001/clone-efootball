  ...
  return (
    <div className="w-full pt-[13px] bg-black">
      <div className='pt-6 mb-[76px] bg-[url("/images/02-box-patterns.webp")] bg-contain bg-center bg-no-repeat rounded-3x'>
        <div className="container max-w-[1250px] mx-auto flex flex-col items-centerl relative">
          <div className="flex flex-col items-center text-xl lg:text-[66px] lg:leading-[76px]">
            ...
            <Image src={"/images/02-all-img.png"} alt="" width={983} height={558} className="mt-2 md:mt-[65px] mb-[180px] md:mb-[175px]" />
          </div>
          <Image
      ...
      <div className='pt-6 mb-[76px] max-w-[1250px] bg-[#131313] bg-[url("/images/03-box-patterns.webp")] bg-cover bg-center bg-no-repeat mx-auto flex flex-col items-center rounded-3xl relative'>
        ...
        <div className="flex flex-col items-center text-lg lg:text-[48px] lg:leading-[55px] -tracking-[0.8]">
