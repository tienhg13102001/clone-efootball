...
const EventCard = () => {
  ...
  return (
    <div className="w-full pt-[13px] bg-black">
      <div className='pt-6 mb-[76px] bg-[url("/images/02-box-patterns.webp")] bg-contain bg-center rounded-3x'>
        <div className="container max-w-[1250px] mx-auto flex flex-col items-centerl relative">
          <div className="flex flex-col items-center text-xl lg:text-[66px] lg:leading-[76px]">
          ...
          <Image
            ...
            alt=""
            width={isMobile ? 500 : 1010}
            height={258}
            className="absolute top-0 left-0 -translate-x-1/2 -translate-y-[100%] lg:-translate-y-1/2 object-contain"
          />
        </div>
      </div>
      {/*  */}
      <div className='pt-6 mb-[76px] max-w-[1250px] bg-[#131313] bg-[url("/images/03-box-patterns.webp")] bg-cover bg-center mx-auto flex flex-col items-center rounded-3xl relative'>
        ...
        <div className="flex flex-col items-center text-xl lg:text-[48px] lg:leading-[55px] -tracking-[0.8]">
          ...
          <div className="mt-[67px] mb-[58px] grid lg:grid-cols-4 grid-cols-2 gap-[24px]">
            {VIDEO_CARDS.map((video, index) => {
              return (
                <div key={index} className="flex flex-col gap-[24px]">
                  <div className="relative">
                    <Image src={video.videoBG} alt="" width={isMobile ? 188 : 258} height={408} />
                    <Image
      ...
      <div className='pt-6 max-w-[1250px] bg-[#131313] bg-[url("/images/04-box-patterns.webp")] bg-cover bg-center mx-auto flex flex-col items-center rounded-3xl relative'>
        ...
        <div className="flex flex-col items-center text-4xl lg:text-[48px] tracking-[0.8]">
          <div className="font-GmarketSans text-center font-medium text-xl lg:text-[40px]/[48px]">
            <p>정정당당 e풋볼 올스타즈 본방 시청하며</p>
            <p className="text-[#d8f700] font-bold">응원 영상 및 인증샷 올리기!</p>
            <p className="text-[#8c8c8c] text-base lg:text-2xl/[48px]">대회 생방송 : 1월 25일 숲(SOOP) & 유튜브 라이브</p>
          </div>
          <Image src={"/images/04-img.webp"} alt="" width={787} height={715} className="mt-[79px] mb-[140px] object-contain" />
        </div>
        <Image
