      ...
      <div className='container max-w-[1250px] mx-auto relative'>
        ...
        <section className='flex flex-col items-center'>
          ...
          <div className='mt-[72px] relative'>
            ...
            <div className='absolute top-5 xs:top-8 lg:top-20 left-[58%]'>
              <p className='text-white text-sm lg:text-[40px] font-bold mb-4 lg:mb-[69px] lg:-tracking-[0.8px] lg:leading-[52px]'>사전 응원 영상 이벤트 <br />
                참여 방법</p>
              <div className='flex gap-2 md:gap-3 items-start mb-3 lg:mb-[53px]'>
                ...
                <p className='text-white text-[10px] lg:text-[28px] font-medium lg:-translate-y-2 lg:leading-[40px]'>유튜브 숏츠, 인스타, 틱톡에
                  <br />
              ...
              <div className='flex gap-2 md:gap-3 items-start'>
                ...
                <p className='text-white text-[10px] lg:text-[28px] font-medium lg:-translate-y-2 lg:leading-[40px]'><span className='text-[#d8f700]'>URL을 복사</span>하고 <br />
                  아래에 입력하여 업로드하기</p>
              </div>
            </div>
          </div>
        ...
        <section className='flex flex-col items-center mt-20 lg:mt-[103px]'>
          ...
          <p className='text-white text-2xl lg:text-[40px] font-bold mb-4 lg:mb-[35px] lg:-tracking-[0.8px] lg:leading-[56px]'>나만의 개성 있는 e풋볼컵<br />
            <span className='text-[#d8f700]'>응원 영상</span>을 올려주세요!</p>
          <p className='text-[#8c8c8c] text-[10px] lg:text-2xl'>SOOP 방송과 함께 인증샷, 방송 관람 영상 등 e풋볼 경기와 함께는 영상을 업로드해 주세요!</p>

          <div className='mt-[72px] relative'>
            <Image src='/images/participate/06-all-box.webp' alt='' width={1250} height={566} className='object-contain' />
            <div className='absolute top-4 xs:top-6 lg:top-16 left-[58%]'>
              <p className='text-white text-sm lg:text-[40px] font-bold mb-3 lg:mb-10 lg:-tracking-[0.8px] lg:leading-[52px]'>관람 인증 이벤트 <br />
                참여 방법</p>
