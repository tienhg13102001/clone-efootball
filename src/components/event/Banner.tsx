...
const Banner = () => {
  return (
    <div className="w-full bg-black bg-[url(/images/main-bg.webp)] bg-contain bg-center">
      <div className="mx-auto pt-96 pb-[298px] flex flex-col items-center">
        <div className="flex flex-col items-center relative drop-shadow-2xl">
          ...
          <p className="font-GmarketSans font-bold text-[#fdd23b] text-[44px] italic drop-shadow-2xl shadow-pink-700">
            eFootballAll stars!
          </p>
          <Image
            ...
            width={504}
            height={340}
            className="absolute top-0 left-0 -translate-x-[200px] -translate-y-[150px]"
          />
        </div>
      </div>
    </div>
