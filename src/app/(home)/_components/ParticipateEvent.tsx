          ...
          <section className='flex flex-col items-center'>
            ...
            <div className='mt-[72px] relative'>
              ...
              <div className='absolute top-5 xs:top-8 lg:top-16 3xl:top-20 left-[58%]'>
                <p className='text-white text-xs md:text-sm lg:text-3xl 3xl:text-[40px] font-bold mb-4 lg:mb-[69px] lg:-tracking-[0.8px] 3xl:leading-[52px]'>사전 응원 영상 이벤트 <br />
                  참여 방법</p>
                <div className='flex gap-2 md:gap-3 items-start mb-3 lg:mb-[53px]'>
                  ...
                  <p className='text-white text-[8px] md:text-[10px] lg:text-2xl 3xl:text-[28px] font-medium lg:-translate-y-2 3xl:leading-[40px]'>유튜브 숏츠, 인스타, 틱톡에
                    <br />
                ...
                <div className='flex gap-2 md:gap-3 items-start'>
                  ...
                  <p className='text-white text-[8px] md:text-[10px] lg:text-2xl 3xl:text-[28px] font-medium lg:-translate-y-2 3xl:leading-[40px]'><span className='text-[#d8f700]'>URL을 복사</span>하고 <br />
                    아래에 입력하여 업로드하기</p>
                </div>
              </div>
            </div>
          ...
          <section className='flex flex-col items-center mt-20 lg:mt-[103px]'>
            ...
            <div className='mt-[72px] relative'>
              ...
              <div className='absolute top-4 xs:top-6 lg:top-10 3xl:top-16 left-[58%]'>
                <p className='text-white text-xs md:text-sm lg:text-4xl 3xl:text-[40px] font-bold mb-3 lg:mb-10 lg:-tracking-[0.8px] 3xl:leading-[52px]'>관람 인증 이벤트 <br />
                  참여 방법</p>
                <div className='flex gap-2 md:gap-3 items-start mb-2 lg:mb-10'>
                  <Image src='/images/participate/05-numberbox-1.webp' alt='numberbox-1' width={isMobile ? 10 : isLapTop ? 20 : 30} height={isMobile ? 10 : isLapTop ? 20 : 30} className='object-contain' />
                  <p className='text-white text-[8px] md:text-[10px] lg:text-xl 3xl:text-[28px] font-medium -translate-y-0.5 lg:-translate-y-1 3xl:-translate-y-2 3xl:leading-[40px]'>SOOP 방송 시청 화면과 <br />
                    응원하는 모습
                    <span className='text-[#d8f700]'>캡쳐하기</span></p>
                </div>
                <div className='flex gap-2 md:gap-3 items-start mb-2 lg:mb-10'>
                  <Image src='/images/participate/05-numberbox-2.webp' alt='numberbox-2' width={isMobile ? 10 : isLapTop ? 20 : 30} height={isMobile ? 10 : isLapTop ? 20 : 30} className='object-contain' />
                  <p className='text-white text-[8px] md:text-[10px] lg:text-xl 3xl:text-[28px] font-medium -translate-y-0.5 lg:-translate-y-1 3xl:-translate-y-2 3xl:leading-[40px]'>유튜브 숏츠, 인스타, 틱톡에 <br />
                    <span className='text-[#d8f700]'>세로용 영상</span>을 업로드하기</p>
                </div>
                ...
                <div className='flex gap-2 md:gap-3 items-start'>
                  ...
                  <p className='text-white text-[8px] md:text-[10px] lg:text-xl 3xl:text-[28px] font-medium -translate-y-0.5 lg:-translate-y-1 3xl:-translate-y-2'>
