    ...
    <div className='w-full bg-[#14189E]'>
      <div className='container max-w-[1000px] 3xl:max-w-[1250px] mx-auto relative'>
        ...
        <div className='py-28 lg:py-[135px]'>
          ...
          <section className='flex flex-col items-center opacity-50'>
            ...
            <div className='mt-[72px] relative'>
              ...
              <div className='absolute top-4 xxs:top-6 xs:top-8 md:top-16 lg:top-10 3xl:top-28 left-[58%]'>
                ...
                <div className='flex gap-2 md:gap-3 items-start'>
                  ...
                  <p className='text-white text-[8px] md:text-base lg:text-xl 3xl:text-[28px] font-medium -translate-y-0.5 lg:-translate-y-1 3xl:-translate-y-2'>
